...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        ar: {
            ...
            contact_address_value: "مساكن الضباط، زهراء مدينة نصر، الحي العاشر، شارع العيادة، عمارة 544، شقة 21",
        ...
        en: {
            ...
            contact_address_value: "Apt 21, Building 544, Al-Eyadah St., 10th District, Zahraa Nasr City, Officers Housing",
            form_name: "Full Name",
